// Config file generation for Familiar setup wizard.
// Generates familiar.json, .env, and mcp-tools.json from dynamic paths and user input.
...
/**
 * Generate a working familiar.json config object.
...
export function generateEnvFile({ anthropicKey, gatewayToken, slackToken, telegramToken }) {
  const lines = [
    ...
    "# Auto-generated by familiar init",
    "",
    anthropicKey
      ? `ANTHROPIC_API_KEY=${anthropicKey}`
      : "# ANTHROPIC_API_KEY=sk-ant-... (optional if using Claude CLI subscription)",
    `FAMILIAR_GATEWAY_TOKEN=${gatewayToken}`,
    "",
  ];
